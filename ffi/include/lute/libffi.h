...
struct ffi_traits<signed char>
{
    static ffi_type* type()
    {
        return detail::ffi_int<signed char>();
    }
};
...
struct ffi_traits<unsigned char>
{
    static ffi_type* type()
    {
        return detail::ffi_int<unsigned char>();
    }
};
...
struct ffi_traits<char16_t>
{
    static ffi_type* type()
    {
        return detail::ffi_int<char16_t>();
    }
};
...
struct ffi_traits<char32_t>
{
    static ffi_type* type()
    {
        return detail::ffi_int<char32_t>();
    }
};
...
struct ffi_traits<unsigned short>
{
    static ffi_type* type()
    {
        return detail::ffi_int<unsigned short>();
    }
};
...
struct ffi_traits<unsigned int>
{
    static ffi_type* type()
    {
        return detail::ffi_int<unsigned int>();
    }
};
...
struct ffi_traits<unsigned long>
{
    static ffi_type* type()
    {
        return detail::ffi_int<unsigned long>();
    }
};
...
struct ffi_traits<long long>
{
    static ffi_type* type()
    {
        return detail::ffi_int<long long>();
    }
};
...
struct ffi_traits<unsigned long long>
{
    static ffi_type* type()
    {
        return detail::ffi_int<unsigned long long>();
    }
};
